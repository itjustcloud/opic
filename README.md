...
공개된 Google Spreadsheet의 C열 JSON을 읽어서 OPIc 스크립트를 편집/추가/학습할 수 있는 앱입니다.
...
앱 데이터는 공개된 Google Spreadsheet CSV만 읽습니다.

## 데이터 파일

스크립트 데이터는 Google Spreadsheet의 C열 JSON에서만 읽습니다.
